...
sys.path.insert(0, str(Path(__file__).resolve().parent))   # fin_books_fixtures lives beside this script
...
def build():
    ...
    # v245: the synthetic books (CONTPAQi prints, the accountants' workbook, overview, tracker, one PMO sheet)
    from fin_books_fixtures import build as build_books
    files.update(build_books())
